...
const createPreviewData = () => ({
  ...
  records: [
    ...
    },
    {
      ...
      content: '创作工具',
      amountCents: 14400,
      occurredAt: '2026-06-18T11:20',
      createdAt: '2026-06-18T03:20:00.000Z',
      updatedAt: '2026-06-18T03:20:00.000Z',
    },
    {
      id: '5',
      typeId: 'ai-bills',
      ...
      content: '模型服务年度充值',
      amountCents: 120000,
      occurredAt: '2026-02-08T14:00',
      createdAt: '2026-02-08T06:00:00.000Z',
      updatedAt: '2026-02-08T06:00:00.000Z',
    },
    {
      id: '6',
      typeId: 'medicine-bills',
      icon: 'pill',
      content: '家庭常备药',
      amountCents: 8600,
      occurredAt: '2026-07-12T18:30',
...
const capture = async () => {
  ...
  await previewWindow.webContents
    .executeJavaScript(`localStorage.setItem('tarobill-preview-data-v1', ${JSON.stringify(JSON.stringify(createPreviewData()))}); location.reload()`)
    .catch(() => undefined);
